$(document).ready(function () {
    $("#categoria").click(function () {
        ...
        if (tipo_cotegoria == 'Cuerpo Completo') {
            ...
            var fila = "<tr><td>  </td><td> 1 </td>  <td> <img src='../images/Eusebia.png'> <td> Eusebia </td><td> Eusebia es una gatita que fue rescatada en un chat en el año 2007, si la rescatas no tendrás mas ratones en tu casa, ya que ella los debora. </td></tr>"
            $("#tabla-categorias").append(fila);
